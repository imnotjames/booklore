...
> **Issue first, PR second.** Every pull request must be linked to an approved issue. If you want to work on something, [open an issue](https://github.com/imnotjames/booklore/issues/new) (or find an existing one) and wait for a maintainer to approve it before writing code. PRs submitted without a linked, approved issue will be closed.
...
First, fork the repository](https://github.com/imnotjames/booklore/fork) on GitHub, then clone your fork locally:

```bash
git clone https://github.com/<your-username>/booklore.git
cd booklore
git remote add upstream https://github.com/imnotjames/booklore.git
```
...
1. **Search [existing issues](https://github.com/imnotjames/booklore/issues)** to avoid duplicates.
...
- **GitHub Issues:** [Report bugs or request features](https://github.com/imnotjames/booklore/issues)
